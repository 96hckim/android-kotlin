package com.hocheol.movieapp.features.common.viewmodel
...
class ThemeViewModel @Inject constructor() : ViewModel() {
    private val _themeState = MutableStateFlow(DefaultComponentConfig.RED_THEME)
    val themeState: StateFlow<ComponentConfig>
        get() = _themeState

    private val _nextColorState = MutableStateFlow(DefaultComponentConfig.BLUE_THEME.colors.LightColors.primary)
