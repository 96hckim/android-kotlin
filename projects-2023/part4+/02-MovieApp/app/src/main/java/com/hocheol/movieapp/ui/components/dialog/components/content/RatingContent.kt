...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val foregroundColor = MaterialTheme.myColorScheme.primary.toArgb()
            val starBackgroundColor = MaterialTheme.myColorScheme.primaryContainer.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.myColorScheme.primaryContainer.copy(
                alpha = 0.05f
            ).toArgb()
