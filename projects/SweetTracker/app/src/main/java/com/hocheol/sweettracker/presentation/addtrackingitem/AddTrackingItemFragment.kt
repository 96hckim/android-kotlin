package com.hocheol.sweettracker.presentation.addtrackingitem
...
import com.hocheol.sweettracker.databinding.FragmentAddTrackingItemBinding
...
//    }
    ...
    private fun bindView() {
        ...
        binding?.invoiceEditText?.addTextChangedListener {
            presenter.changeShippingInvoice(it.toString())
        }
