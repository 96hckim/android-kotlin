package com.hocheol.delivery.screen.review.camera
...
import com.hocheol.delivery.databinding.ActivityCameraBinding
import com.hocheol.delivery.extensions.load
import com.hocheol.delivery.screen.review.camera.preview.ImagePreviewListActivity
import com.hocheol.delivery.util.path.PathUtil
import java.io.File
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun bindPreviewImageViewClickListener() = with(binding) {
        previewImageVIew.setOnClickListener {
            imagePreviewListLauncher.launch(ImagePreviewListActivity.newIntent(this@CameraActivity, uriList))
        }
    }
