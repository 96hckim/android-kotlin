package com.hocheol.usedtrade.mypage
...
import com.hocheol.usedtrade.databinding.FragmentMypageBinding
        ...
        fragmentMypageBinding.signInOutButton.setOnClickListener {
            binding?.let { binding ->
                ...
                if (auth.currentUser == null) {
                    ...
                    binding.signInOutButton.text = getString(R.string.login)
    ...
    override fun onStart() {
        ...
        if (auth.currentUser == null) {
            ...
            binding?.let { binding ->
                ...
                binding.signInOutButton.text = getString(R.string.logout)
