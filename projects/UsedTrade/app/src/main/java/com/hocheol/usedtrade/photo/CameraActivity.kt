...
import com.hocheol.usedtrade.databinding.ActivityCameraBinding
import com.hocheol.usedtrade.extensions.loadCenterCrop
import com.hocheol.usedtrade.util.PathUtil
import java.io.File
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun bindPreviewImageViewClickListener() = with(binding) {
        previewImageVIew.setOnClickListener {
            imageListLauncher.launch(ImageListActivity.newIntent(this@CameraActivity, uriList))
        }
    }
